...
plt.ylim(0, 1.1)
plt.title("Random 3-SAT", fontsize=14)
...
plt.ylim(0, 0.25)
plt.axhline(y=0.125, color='black', linewidth=2, label='Random Guess')
plt.title("Random 3-SAT", fontsize=14)
plt.xlabel(r'$\alpha$', fontsize=14)
