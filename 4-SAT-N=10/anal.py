...
plt.ylim(0, 1.1)
plt.title("Random 4-SAT", fontsize=14)
# Add labels and legend
plt.xlabel(r'$\alpha$', fontsize=14)
plt.ylabel('P(SAT. ASSIG.)', fontsize=14)
plt.legend(fontsize=14, loc='upper center', bbox_to_anchor=(0.3, 0.47))
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
plt.savefig("4-sat.jpeg")
# Show the plot
plt.show()
plt. close()
...
plt.ylim(0, 0.15)
plt.axhline(y=0.0625, color='black', linewidth=2, label='Random Guess')
plt.title("Random 4-SAT", fontsize=14)
plt.xlabel(r'$\alpha$', fontsize=14)
